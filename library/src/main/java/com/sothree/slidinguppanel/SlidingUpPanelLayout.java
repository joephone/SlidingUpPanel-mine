...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_PANEL_HEIGHT = 35; // dp;
     ...
     */
    private static PanelState DEFAULT_SLIDE_STATE = PanelState.MID;
     ...
     */
    private static final int DEFAULT_FADE_COLOR = 0x00000000  ; //0x99000000
            ...
            mDragView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(mSlideState == PanelState.COLLAPSED ||mSlideState == PanelState.EXPANDED){
                        setPanelState(PanelState.MID);
                        mSlideState = PanelState.MID;
                    } else if (mSlideState == PanelState.MID||mSlideState == PanelState.ANCHORED) {
